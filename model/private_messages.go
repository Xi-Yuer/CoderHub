...
type UserSession struct {
	...
	CreatedAt          time.Time `gorm:"column:created_at;comment:创建时间戳（毫秒）" json:"created_at"`
	UpdatedAt          time.Time `gorm:"column:updated_at;comment:最后更新时间戳（毫秒）" json:"updated_at"`
}
