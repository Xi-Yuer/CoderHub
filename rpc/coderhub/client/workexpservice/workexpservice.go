...
type (
	...
	defaultWorkExpService struct {
		cli zrpc.Client
	}
)

func NewWorkExpService(cli zrpc.Client) WorkExpService {
	return &defaultWorkExpService{
		cli: cli,
	}
}

func (m *defaultWorkExpService) CreateWorkExp(ctx context.Context, in *CreateWorkExpRequest, opts ...grpc.CallOption) (*CreateWorkExpResponse, error) {
	client := coderhub.NewWorkExpServiceClient(m.cli.Conn())
	return client.CreateWorkExp(ctx, in, opts...)
}

func (m *defaultWorkExpService) DeleteWorkExp(ctx context.Context, in *DeleteWorkExpRequest, opts ...grpc.CallOption) (*DeleteWorkExpResponse, error) {
	client := coderhub.NewWorkExpServiceClient(m.cli.Conn())
	return client.DeleteWorkExp(ctx, in, opts...)
}

func (m *defaultWorkExpService) GetWorkExpList(ctx context.Context, in *GetWorkExpListRequest, opts ...grpc.CallOption) (*GetWorkExpListResponse, error) {
	client := coderhub.NewWorkExpServiceClient(m.cli.Conn())
	return client.GetWorkExpList(ctx, in, opts...)
}
