...
type (
	...
	defaultSchoolExpService struct {
		cli zrpc.Client
	}
)

func NewSchoolExpService(cli zrpc.Client) SchoolExpService {
	return &defaultSchoolExpService{
		cli: cli,
	}
}

func (m *defaultSchoolExpService) CreateSchoolExp(ctx context.Context, in *CreateSchoolExpRequest, opts ...grpc.CallOption) (*CreateSchoolExpResponse, error) {
	client := coderhub.NewSchoolExpServiceClient(m.cli.Conn())
	return client.CreateSchoolExp(ctx, in, opts...)
}

func (m *defaultSchoolExpService) DeleteSchoolExp(ctx context.Context, in *DeleteSchoolExpRequest, opts ...grpc.CallOption) (*DeleteSchoolExpResponse, error) {
	client := coderhub.NewSchoolExpServiceClient(m.cli.Conn())
	return client.DeleteSchoolExp(ctx, in, opts...)
}

func (m *defaultSchoolExpService) GetSchoolExpList(ctx context.Context, in *GetSchoolExpListRequest, opts ...grpc.CallOption) (*GetSchoolExpListResponse, error) {
	client := coderhub.NewSchoolExpServiceClient(m.cli.Conn())
	return client.GetSchoolExpList(ctx, in, opts...)
}
