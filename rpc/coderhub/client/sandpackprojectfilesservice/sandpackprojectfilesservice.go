...
package sandpackprojectfilesservice
...
type (
	...
	SandpackProjectFilesService interface {
	...
	defaultSandpackProjectFilesService struct {
		cli zrpc.Client
	}
)

func NewSandpackProjectFilesService(cli zrpc.Client) SandpackProjectFilesService {
	return &defaultSandpackProjectFilesService{
		cli: cli,
	}
}

func (m *defaultSandpackProjectFilesService) CreateSandpackProjectFiles(ctx context.Context, in *SandpackProjectFilesResponse, opts ...grpc.CallOption) (*CreateSandpackProjectFilesResponse, error) {
	client := coderhub.NewSandpackProjectFilesServiceClient(m.cli.Conn())
	return client.CreateSandpackProjectFiles(ctx, in, opts...)
}

func (m *defaultSandpackProjectFilesService) GetSandpackProjectFiles(ctx context.Context, in *GetSandpackProjectFilesRequest, opts ...grpc.CallOption) (*SandpackProjectFilesResponse, error) {
	client := coderhub.NewSandpackProjectFilesServiceClient(m.cli.Conn())
	return client.GetSandpackProjectFiles(ctx, in, opts...)
}
