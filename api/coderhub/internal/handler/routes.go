	...
	server.AddRoutes(
		[]rest.Route{
			...
			},
			{
				...
				Method:  http.MethodGet,
				Path:    "/extra/:id",
				Handler: articles_public.GetArticleExtraHandler(serverCtx),
			},
			{
				// 获取文章列表
				Method:  http.MethodGet,
			...
			},
			{
				...
				Method:  http.MethodGet,
				Path:    "/user/:user_id",
				Handler: articles_public.GetArticlesByUserHandler(serverCtx),
			},
		},
		rest.WithPrefix("/api/articles"),
	)
		...
		[]rest.Route{
			{
				...
				Method:  http.MethodDelete,
				Path:    "/delete/:id",
				Handler: message_auth.DeleteMessageHandler(serverCtx),
			},
			{
				// 获取消息列表
				Method:  http.MethodGet,
